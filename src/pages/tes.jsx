...
const Home = () => {
	...
	useEffect(() => {
		const handleMousemove = (r) => {
			const o = document.querySelectorAll('.hero-elements-img');
			const n = document.querySelectorAll('.hero-dashboard-img');
			o.forEach((e) => {
				e.style.transform = 'translateZ(1rem)';
			});
			n.forEach((e) => {
				const t = (window.innerWidth - 2 * r.pageX) / 100;
				const n = (window.innerHeight - 2 * r.pageY) / 100;
						...
						<div className="text-center mb-5">
							<div className="position-relative d-inline-block pt-3 pt-md-0">
								<label className="switch switch-primary me-0">
									...
									<input type="checkbox" className="switch-input price-duration-toggler" checked onChange={function () {
									...
									{/* <input type="checkbox" className="switch-input price-duration-toggler" defaultChecked={true} /> */}
